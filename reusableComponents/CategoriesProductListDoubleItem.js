    ...
    render() {
        return (
            <TouchableOpacity activeOpacity={0.9} style={styles.button} onPress={this.navigateToProductPage}>
                ...
                <Text style={styles.subText}>{this.props.name2}</Text>
...
const styles = StyleSheet.create({
    ...
    mainText: { marginTop: 9, maxWidth: Width * 0.43, fontFamily: "Montserrat-Medium", fontSize: 16, lineHeight: 20, color: "#2d2d2f" },
