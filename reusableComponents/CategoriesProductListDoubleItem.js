    ...
    render() {
        ...
        return (
            <View style={{ maxWidth: Width / 2}}>
                <Image source={this.props.imageUrl} style={{ height: Height * 0.3, width: Width * 0.43,justifyContent:"center" }} />
                {/* orignal width is 0.12 currently 0.30 due to long height image, height is 0.26 currently 0.20 */}
                <Text style={{ maxWidth:Width * 0.43,fontFamily: "Montserrat-Medium", fontSize: 16, lineHeight: 20, color: "#2d2d2f",textAlign:"justify"}}>{this.props.name1}</Text>
