...
class CategoriesProductListSingleItem extends PureComponent {
    render() {
        ...
        return (
            <View>
                <Image source={this.props.imageUrl} style={{alignSelf:"center", height: Height * 0.5, width: Width*0.88 }} />
                ...
                <View style={{paddingVertical:9,paddingHorizontal:20,flexDirection:"row",justifyContent:"space-between"}}>
                    <Text style={{fontFamily:"Montserrat-Medium",fontSize:16,lineHeight:20,color:"#2d2d2f"}}>{this.props.name1}</Text>
                    <Text style={{fontSize:16,lineHeight:20,fontFamily:"Montserrat-Medium",color:"#2d2d2f"}}>{this.props.price1}</Text>
                </View>
                <View style={{paddingHorizontal:20,flexDirection:"row",justifyContent:"space-between"}}>
                    <Text style={{fontFamily:"Avenir-Book",fontSize:14,lineHeight:18,color:"#2967ff"}}>{this.props.name2}</Text>
